...
class Config:
    ...
    def validate_and_strip_dict(self, key, config_dict, config_requirements):
        ...
        valid = True
        for required_key, required_type in required_entries.iteritems():
        ...
        for optional_key, optional_type in optional_entries.iteritems():
        ...
        if 'children' in config_requirements:
            for child_key, child_value in config_requirements['children'].iteritems():
